...
function preload() {
  ballCollideSound = loadSound('ball_touch_paddel.wav');
  ballNotCollideSound = loadSound('missed.wav');
  ballCollideSound.setVolume(1);
  ballCollideSound.rate(1);
  ballNotCollideSound.setVolume(1);
  ballNotCollideSound.rate(1);
}
...
function gotPoses(results) {
  if (results.length > 0) {
    ...
    rightWristScore = results[0].pose.keypoints[16].score;
